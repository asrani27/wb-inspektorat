...
<div class="col-12">
    <form class="card" method="POST" action="/admin/sektor/edit/{{$data->id}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card-body">
                <div class="row row-cards">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <input type="text" class="form-control" name="nama" placeholder="Nama sektor" value="{{$data->nama}}" required>
                        </div>
                    </div>
                </div>
